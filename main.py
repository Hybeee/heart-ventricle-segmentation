...
def _save_mask_with_reference(mask_3d: np.ndarray, reference_image: sitk.Image, output_path: str, color=None, segment_name="mask"):
    ...
    mask_sitk.SetMetaData("Segment0_ID", "Segment_0")
    mask_sitk.SetMetaData("Segment0_Name", segment_name)
    mask_sitk.SetMetaData("Segment0_LabelValue", "1")
    mask_sitk.SetMetaData("Segment0_Layer", "0")
    mask_sitk.SetMetaData("Segment0_Color", color)
    mask_sitk.SetMetaData("Segment0_ColorAutoGenerated", "0")

    non_zero_indices = np.nonzero(mask_3d)
